...
export const ALL_PRODUCTS: Product[] = [
  ...
  // --- CATEGORIA CASA ---
  {
    ...
    description: 'Friggitrice ad aria L, 4.1L, Tecnologia Rapid Air, controlli touch, facile da pulire.',
    price: 89.99,
    originalPrice: 129.99,
    rating: 4.6,
    reviewCount: 3200,
    imageUrl: 'https://images.unsplash.com/photo-1626168393539-7ae372eb4c02?auto=format&fit=crop&q=80&w=2000',
    affiliateLink: '#',
    isPrime: true,
    isBestSeller: true,
  },
